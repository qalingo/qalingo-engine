...
CREATE TABLE `teco_product_marketing_attribute` (
  ...
  KEY `FKC35BC1716D70848F` (`MARKET_AREA_ID`),
  ...
  CONSTRAINT `FKC35BC1716D70848F` FOREIGN KEY (`MARKET_AREA_ID`) REFERENCES `teco_market_area` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-07-31 15:01:48
