...
CREATE TABLE `teco_product_sku` (
  ...
  KEY `FKF5E65EEBE882DB60` (`DEFAULT_CATALOG_CATEGORY_ID`),
  CONSTRAINT `FKF5E65EEBE882DB60` FOREIGN KEY (`DEFAULT_CATALOG_CATEGORY_ID`) REFERENCES `teco_catalog_virtual_category` (`ID`),
