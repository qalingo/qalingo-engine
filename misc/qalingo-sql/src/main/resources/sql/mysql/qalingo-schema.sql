...
CREATE TABLE `teco_cart_item` (
  ...
  KEY `FKB7F201B0585BC78` (`PRODUCT_SKU_ID`),
  CONSTRAINT `FKB7F201B0585BC78` FOREIGN KEY (`PRODUCT_SKU_ID`) REFERENCES `teco_product_marketing` (`ID`),
...
CREATE TABLE `teco_delivery_method_price` (
  ...
  CONSTRAINT `FKAB3756945CAFB757` FOREIGN KEY (`DELIVERY_METHOD_ID`) REFERENCES `teco_delivery_methods` (`ID`),
  CONSTRAINT `FKAB37569424F2670D` FOREIGN KEY (`CURRENCY_ID`) REFERENCES `teco_currency_referential` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `teco_delivery_methods`
--

DROP TABLE IF EXISTS `teco_delivery_methods`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `teco_delivery_methods` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT,
  `CODE` varchar(255) DEFAULT NULL,
  `DATE_CREATE` datetime DEFAULT NULL,
  `DATE_UPDATE` datetime DEFAULT NULL,
...
CREATE TABLE `teco_engine_session` (
  ...
  `CART_ID` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `FK3ECC475B10E2356E` (`CART_ID`),
  CONSTRAINT `FK3ECC475B10E2356E` FOREIGN KEY (`CART_ID`) REFERENCES `teco_cart` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `teco_market_area` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `CODE` (`CODE`),
  KEY `FK6179540E24F2670D` (`CURRENCY_ID`),
  ...
  CONSTRAINT `FK6179540E24F2670D` FOREIGN KEY (`CURRENCY_ID`) REFERENCES `teco_currency_referential` (`ID`),
...
CREATE TABLE `teco_market_area_delivery_method_rel` (
  ...
  CONSTRAINT `FKF8892F955CAFB757` FOREIGN KEY (`DELIVERY_METHOD_ID`) REFERENCES `teco_delivery_methods` (`ID`),
...
CREATE TABLE `teco_market_area_payment_gateway_rel` (
  ...
  CONSTRAINT `FK61404D5444663178` FOREIGN KEY (`PAYMENT_GATEWAY_ID`) REFERENCES `teco_delivery_methods` (`ID`),
...
CREATE TABLE `teco_order_item` (
  ...
  KEY `FKB57F306664678FC4` (`ORDER_ID`),
  CONSTRAINT `FKB57F306664678FC4` FOREIGN KEY (`ORDER_ID`) REFERENCES `teco_order_customer` (`ID`),
...
CREATE TABLE `teco_order_tax` (
  ...
  `ORDER_ID` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `FK923E0FD864678FC4` (`ORDER_ID`),
  CONSTRAINT `FK923E0FD864678FC4` FOREIGN KEY (`ORDER_ID`) REFERENCES `teco_order_customer` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `teco_product_marketing_type` (
  ...
  `NAME` varchar(255) DEFAULT NULL,
  `VERSION` int(11) NOT NULL DEFAULT '1',
  `PRODUCT_MARKETING_TYPE_FAMILLY_ID` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `CODE` (`CODE`),
  KEY `FK6EE63B259A35C3F1` (`PRODUCT_MARKETING_TYPE_FAMILLY_ID`),
  CONSTRAINT `FK6EE63B259A35C3F1` FOREIGN KEY (`PRODUCT_MARKETING_TYPE_FAMILLY_ID`) REFERENCES `teco_product_marketing_type_familly` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `teco_product_marketing_type_familly`
--

DROP TABLE IF EXISTS `teco_product_marketing_type_familly`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `teco_product_marketing_type_familly` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT,
  `CODE` varchar(255) DEFAULT NULL,
  `DATE_CREATE` datetime DEFAULT NULL,
  `DATE_UPDATE` datetime DEFAULT NULL,
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `CODE` (`CODE`),
  KEY `FKD32D88C8575EEFA6` (`TAX_ID`),
  CONSTRAINT `FKD32D88C8575EEFA6` FOREIGN KEY (`TAX_ID`) REFERENCES `teco_tax` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `teco_retailer_customer_comment` (
  ...
  KEY `FK14A532BE6A20827` (`RETAILER_ID`),
  CONSTRAINT `FK14A532BE6A20827` FOREIGN KEY (`RETAILER_ID`) REFERENCES `teco_retailer_customer_comment` (`ID`),
...
CREATE TABLE `teco_rule_repository_attribute` (
  ...
  KEY `FKAF7542086BFDE76B` (`RULE_REFERENTIAL_ID`),
  CONSTRAINT `FKAF7542086BFDE76B` FOREIGN KEY (`RULE_REFERENTIAL_ID`) REFERENCES `teco_rule_referential` (`ID`),
...
CREATE TABLE `teco_shipping_country` (
  ...
  `SHIPPING_ID` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `FKB02EDF478601A5F5` (`SHIPPING_ID`),
  CONSTRAINT `FKB02EDF478601A5F5` FOREIGN KEY (`SHIPPING_ID`) REFERENCES `teco_delivery_methods` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `teco_shipping_county` (
  ...
  PRIMARY KEY (`ID`),
  KEY `FKD4228B59EBFB6B69` (`SHIPPING_COUNTRY_ID`),
  CONSTRAINT `FKD4228B59EBFB6B69` FOREIGN KEY (`SHIPPING_COUNTRY_ID`) REFERENCES `teco_shipping_country` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-12-12 20:39:39
