...
(40, 'GROUP_BO_COMPANY', NULL, 'GROUP_BO_COMPANY', 1);
...
(40, 'ROLE_BO_COMPANY_VIEWER', NULL, 'ROLE_BO_COMPANY_VIEWER', 1),
(41, 'ROLE_BO_COMPANY_ADMIN', NULL, 'ROLE_BO_COMPANY_ADMIN', 1);
...
(1015, 'Setting resource assets product sku file path', 'Setting resource assets product sku file path', 'ASSET_PRODUCT_SKU_FILE_PATH', '/images/catalog/product-sku', 1),
(1016, 'Setting resource assets product brand file path', 'Setting resource assets product brand file path', 'ASSET_PRODUCT_BRAND_FILE_PATH', '/images/catalog/product-brand', 1),
(1017, 'Setting resource assets retailer & store file path', 'Setting resource assets retailer & store file path', 'ASSET_RETAILER_STORE_FILE_PATH', '/images/retailer-store', 1);
