...
(1016, 'Setting resource assets product brand file path', 'Setting resource assets product brand file path', 'ASSET_PROPDUCT_BRAND_FILE_PATH', '/images/catalog/product-brand', 1),
