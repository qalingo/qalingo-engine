...
public class LogoutController extends AbstractMCommerceController {
	...
	@RequestMapping(FoUrls.LOGOUT_URL)
	public ModelAndView logout(final HttpServletRequest request, final HttpServletResponse response) throws Exception {
		ModelAndViewThemeDevice modelAndView = new ModelAndViewThemeDevice(getCurrentVelocityPath(request), FoUrls.LOGOUT.getVelocityPage());
