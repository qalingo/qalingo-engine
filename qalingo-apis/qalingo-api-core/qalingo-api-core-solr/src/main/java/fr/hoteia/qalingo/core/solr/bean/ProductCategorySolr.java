...
public class ProductCategorySolr {
    ...
    @Field
    private Set<ProductCategorySolr> productCategories = new HashSet<ProductCategorySolr>();
	...
	public Set<ProductCategorySolr> getProductCategories() {
		return productCategories;
	}

	public void setProductCategories(Set<ProductCategorySolr> productCategories) {
