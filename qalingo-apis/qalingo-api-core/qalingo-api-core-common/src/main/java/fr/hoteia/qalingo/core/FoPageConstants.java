...
public final class FoPageConstants {

	// PRE HOME
	public static final String PRE_HOME_KEY = "prehome";
	public static final String PRE_HOME_URL = "/home.html";
	public static final String PRE_HOME_VELOCITY_PAGE = "prehome";

	// HOME
	public static final String HOME_KEY = "conditionsofuse";
