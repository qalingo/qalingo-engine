 ...
 *
 */
package fr.hoteia.qalingo.core.web.filter;
...
public class UrlTrackingFilter implements Filter {
    ...
    public void doFilter(final ServletRequest servletRequest, final ServletResponse servletResponse, final FilterChain chain) throws IOException, ServletException {
    	...
    	try {
			requestUtil.addClickstream(httpServletRequest);
		} catch (Exception e) {
			logger.error("UrlTracking Filter & addClickstream failed, e");
		}
