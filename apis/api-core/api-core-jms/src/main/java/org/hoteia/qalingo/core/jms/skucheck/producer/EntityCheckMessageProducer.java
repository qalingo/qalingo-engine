...
@Component(value = "entityCheckMessageProducer")
public class EntityCheckMessageProducer {

    protected final Log logger = LogFactory.getLog(getClass());

    @Resource(name="entityCheckJmsTemplate")
     ...
     */
    public void generateAndSendMessages(final EntityCheckMessageJms messageJms) throws JMSException, UnsupportedEncodingException {
        try {
