...
public abstract class AbstractOAuthFrontofficeController extends AbstractFrontofficeQalingoController {
    ...
    protected static final String YAHOO_URL = "https://api.login.yahoo.com/oauth/v2/";
    ...
    protected static final String YAHOO_OAUTH_REQUEST_TOKEN = "YAHOO_OAUTH_REQUEST_TOKEN";
