...
{
    protected RuntimeInstance ri = new RuntimeInstance();
     ...
     */
     ...
     public void forceFlushCache(){
		if(ri != null && ri.getResourceManager() != null) {
			ResourceCache globalCache = ri.getResourceManager().getGlobalCache();
			List<Object> keys = new ArrayList<Object>();
	        for (Iterator<Object> iterator = globalCache.enumerateKeys(); iterator.hasNext();) {
