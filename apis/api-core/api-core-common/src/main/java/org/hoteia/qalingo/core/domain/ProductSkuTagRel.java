...
@AssociationOverrides({
    ...
    @AssociationOverride(name = "pk.productSkuTag", joinColumns = @JoinColumn(name = "PRODUCT_SKU_TAG_ID"))})
public class ProductSkuTagRel extends AbstractEntity<ProductSkuTagRel> {
    ...
    public ProductSkuTagRel(final ProductSku productSku, final ProductSkuTag productSkuTag) {
        this.pk = new ProductSkuTagPk(productSku, productSkuTag);
    }
    ...
    public ProductSkuTag getProductSkuTag() {
        return getPk().getProductSkuTag();
    }

    public void setProductSkuTagP(final ProductSkuTag productSkuTag) {
        pk.setProductSkuTag(productSkuTag);
    }
