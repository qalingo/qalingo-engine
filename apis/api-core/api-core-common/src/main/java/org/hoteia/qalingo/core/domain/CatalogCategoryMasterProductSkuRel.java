...
public class CatalogCategoryMasterProductSkuRel extends AbstractEntity<CatalogCategoryMasterProductSkuRel> implements DomainEntity {
    ...
    public CatalogCategoryMasterProductSkuRel() {
        this.pk = new CatalogCategoryMasterProductSkuPk();
    }
