...
public class ProductBrandTag extends AbstractEntity {

	/**
	 * Generated UID
	 */
	private static final long serialVersionUID = 1295787776013413L;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        ProductBrandTag other = (ProductBrandTag) obj;
        if (code == null) {
            if (other.code != null)
                return false;
    ...
    public String toString() {
        return "ProductMarketingTag [id=" + id + ", version=" + version + ", name=" + name + ", code=" + code + ", description=" + description + ", isDefault=" + isDefault + ", isGlobal=" + isGlobal
