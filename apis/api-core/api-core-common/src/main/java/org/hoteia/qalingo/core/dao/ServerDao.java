...
public class ServerDao extends AbstractGenericDao {
    ...
    /**
     * @throws IOException
     * @see org.hoteia.qalingo.core.dao.ServerDao#saveOrUpdateServerStatus(ServerStatus serverStatus, String message)
     */
