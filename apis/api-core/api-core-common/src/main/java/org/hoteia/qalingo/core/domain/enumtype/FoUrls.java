...
public enum FoUrls {
    ...
    COLLECTION(FoUrls.COLLECTION_URL, FoUrls.COLLECTION_KEY, FoUrls.COLLECTION_VELOCITY_PAGE, true),
    ...
    public static final String COLLECTION_URL                      = "/**/collection-{" + RequestConstants.URL_PATTERN_COLLECTION_CODE + ":[a-zA-Z0-9-]+}.html";
    public static final String COLLECTION_VELOCITY_PAGE            = "catalog/collection";
