...
public enum BoUrls {
    ...
    CANCEL_RESET_PASSWORD(BoUrls.CANCEL_RESET_PASSWORD_URL, BoUrls.CANCEL_RESET_PASSWORD_KEY, BoUrls.CANCEL_RESET_PASSWORD_VELOCITY_PAGE, true),
    ...
    public static final String MANAGE_PAGES_VELOCITY_PAGE    = "cms/page/manage-pages";
