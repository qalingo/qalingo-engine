...
public class VelocityPageContextDataPojo {
    ...
    private String backofficeLocalizationCode;
    ...
    public String getBackofficeLocalizationCode() {
        return backofficeLocalizationCode;
    }

    public void setBackofficeLocalizationCode(String backofficeLocalizationCode) {
        this.backofficeLocalizationCode = backofficeLocalizationCode;
    }
