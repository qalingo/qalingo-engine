...
public abstract class AbstractAttribute extends AbstractEntity {
    ...
    public static String PRODUCT_MARKETING_ATTRIBUTE_FEATURED = "PRODUCT_MARKETING_ATTRIBUTE_FEATURED";
    ...
    public static String PRODUCT_SKU_ATTRIBUTE_WIDTH = "PRODUCT_SKU_ATTRIBUTE_WIDTH";
    public static String PRODUCT_SKU_ATTRIBUTE_HEIGHT = "PRODUCT_SKU_ATTRIBUTE_HEIGHT";
    public static String PRODUCT_SKU_ATTRIBUTE_LENGTH = "PRODUCT_SKU_ATTRIBUTE_LENGTH";
    public static String PRODUCT_SKU_ATTRIBUTE_WEIGHT = "PRODUCT_SKU_ATTRIBUTE_WEIGHT";
